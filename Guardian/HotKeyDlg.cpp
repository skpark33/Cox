...
void CHotKeyDlg::OnPaint()
{
	...
	m_parent->WriteSingleLine(_T("Version ") + m_version, &dc, m_parent->m_alarmFont5, RGB(0xff, 0xff, 0xff), posY1, height, 1, posX1, width);
...
BOOL CHotKeyDlg::OnInitDialog()
{
	...
	m_btF8.LoadBitmap(IDB_BITMAP_REGISTRATION, RGB(232, 168, 192));
	m_btOK.LoadBitmap(IDB_BITMAP_CLOSE, RGB(232, 168, 192));
	m_btF9.LoadBitmap(IDB_BITMAP_CLOSE_ALL, RGB(232, 168, 192));
	m_btBrightUp.LoadBitmap(IDB_BITMAP_BRIGHT_UP, RGB(232, 168, 192));
	m_btBrightDown.LoadBitmap(IDB_BITMAP_BRIGHT_DOWN, RGB(232, 168, 192));
	m_btContrastUp.LoadBitmap(IDB_BITMAP_CONT_UP, RGB(232, 168, 192));
	m_btContrastDown.LoadBitmap(IDB_BITMAP_CONT_DOWN, RGB(232, 168, 192));
	m_btDel.LoadBitmap(IDB_BITMAP_DEL, RGB(232, 168, 192));
	m_btKillBrowser.LoadBitmap(IDB_BITMAP_CLOSE_VIDEO, RGB(232, 168, 192));
	m_btF12Full.LoadBitmap(IDB_BITMAP_FULL_CAMERA, RGB(232, 168, 192));
	m_btF12Shrink.LoadBitmap(IDB_BITMAP_SHRINK_CAMERA, RGB(232, 168, 192));
	m_btF4Wide.LoadBitmap(IDB_BITMAP_WIDE, RGB(232, 168, 192));
	m_btF4Narrow.LoadBitmap(IDB_BITMAP_NARROW, RGB(232, 168, 192));
	m_btF5Normal.LoadBitmap(IDB_BITMAP_NORMAL, RGB(232, 168, 192));
	m_btF5Thermal.LoadBitmap(IDB_BITMAP_THERMAL, RGB(232, 168, 192));
	m_btF7.LoadBitmap(IDB_BITMAP_UPLOADER, RGB(232, 168, 192));
	m_btF3.LoadBitmap(IDB_BITMAP_CAMERA_WEB, RGB(232, 168, 192));
	...
	memset(buf, 0x00, 10);
	GetPrivateProfileString(ENTRY_NAME, _T("CAMERA"), _T("0"), buf, 10, iniPath);
	bool  isThermal = bool((_wtoi(buf) == 1));
	...
	m_btF3.ShowWindow(SW_HIDE);
	m_btF4Narrow.ShowWindow(SW_HIDE);
	m_btF4Wide.ShowWindow(SW_HIDE);
	m_btBrightUp.ShowWindow(SW_HIDE);
	m_btBrightDown.ShowWindow(SW_HIDE);
	m_btContrastUp.ShowWindow(SW_HIDE);
	m_btContrastDown.ShowWindow(SW_HIDE);
