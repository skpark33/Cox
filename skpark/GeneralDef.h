...
#define ALARM_CHECK_TIMER		24		//skpark new alarm validate time
#define ID_VIDEO_REPAINT		25		//skpark video play timer
#define SCHEDULE_SHOW_ID		26		//skpark video play timer
#define SCHEDULE_HIDE_ID		27		//skpark video play timer
...
typedef struct STRU_LOCAL_PARAM
{
	...
	STRU_LOCAL_PARAM()
	{
		...
		sprintf(chPictureSavePath, "%s", "C:\\SQISoft\\Upload");  //skpark savePicture
